...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 09, 2022 lúc 04:40 AM
...
--
-- Cơ sở dữ liệu: `1951060941_libraries`
--
...
(1951060941, 'Nguyễn Công Quân', 'nam', 2001, 'học sinh', '2001-01-17', '2090-01-17', 'Nam định');
...
--
ALTER TABLE `docgia`
  MODIFY `madg` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1951060942;
COMMIT;
